...
STATIC_ANOMALIES = [
    ...
    b'\xc3\xa5\xc3\xa4\xc3\xb6',  # Scandinavian characters (åäö) as UTF-8
    ...
    six.unichr(0),  # NULL
    six.unichr(0) + u'xxxxxxxx',  # NULL followed by more data
    six.unichr(0x1a),  # ctrl-z (end of stream)
    b'\xff\xfe',  # Illegal unicode as string
    b'\xff\xff',  # Illegal unicode as string
    '\t',  # tab
    ...
    b'c\x00\x00\x00\x0Djavascript_code\x00\x09\x00\x00\x00alert(1)\x00\x01float\x00\x00\x00\x00\x00\x00\x00E@\x08Boolean\x00\x02\x04array\x00\x05\x00\x00\x00\x00\nNull\x00\x02unicodestring\x00\x02\x00\x00\x00\x00\x00\x00',  # Broken BSON (invalid Boolean value)
    b'c\x00\x00\x00\x0Djavascript_code\x00\x09\x00\x00\x00alert(1)\x00\x01float\x00\x00\x00\x00\x00\x00\x00E@\x08Boolean\x00\x01\x04array\x00\x06\x00\x00\x00\x00\nNull\x00\x02unicodestring\x00\x02\x00\x00\x00\x00\x00\x00',  # Broken BSON 2 (embedded document length overflow)
    b'c\x00\x00\x00\x0Djavascript_code\x00\x09\x00\x00\x00alert(1)\x00\x01float\x00\x00\x00\x00\x00\x00\x00E@\x08Boolean\x00\x01\x04array\x00\x05\x00\x00\x00\x00\nNull\x00\x02unicodestring\x00\x03\x00\x00\x00\x00\x00\x00',  # Broken BSON 3 (string length overflow)
